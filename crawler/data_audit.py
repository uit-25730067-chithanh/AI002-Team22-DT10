"""Audit helpers for processed coffee datasets."""
...
try:
    from .data_quality import summarize_observed_data_completeness
except ImportError:
    from data_quality import summarize_observed_data_completeness
...
def write_markdown_report(
    ...
    lines = [
        ...
        "## Summary",
        "",
        "- Dataset duoc thu thap va tai tao tu nguon public.",
        "- Monthly dataset co source evidence fields: `source_url_count`, `source_names`.",
        "",
        "## Dataset size",
        "",
        ...
        "",
        "- Can xac nhan nguong observed rate theo tung tinh khi mo rong du lieu.",
    ]
    output.write_text("\n".join(lines) + "\n", encoding="utf-8")
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-csv",
        default="data/processed/area_real_price_data_ranking.csv",
    )
    parser.add_argument(
        "--report",
        default="docs/discussions/2026-06-08-coffee-data-audit.md",
    )
