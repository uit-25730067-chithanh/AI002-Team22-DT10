"""Constants for the official coffee dataset pipeline."""
...
DATASET_ID = "coffee_environment_2020_2026"
...
MONTHLY_OUTPUT_FILE = (
    ...
    / f"coffee_environment_all_areas_monthly_{YEAR_RANGE_LABEL}.csv"
)
WEEKLY_OUTPUT_FILE = (
    PROCESSED_WEEKLY_DIR
    / f"coffee_environment_all_areas_weekly_{YEAR_RANGE_LABEL}.csv"
)
