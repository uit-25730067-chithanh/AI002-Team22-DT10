...
const FarmingInputForm: React.FC<FarmingInputFormProps> = ({ onSubmit, isLoading }) => {
  ...
  const fieldClasses =
    'rounded-lg border-2 border-coffee-800 bg-white p-3 font-sans text-base focus:outline focus:outline-[3px] focus:-outline-offset-2 focus:outline-leaf-500 aria-[invalid=true]:border-red-600 disabled:bg-coffee-100 disabled:text-coffee-700';
