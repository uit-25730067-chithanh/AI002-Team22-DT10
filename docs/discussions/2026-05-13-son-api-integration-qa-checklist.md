...
**Scope:** Danh sách kiểm tra test API/frontend cho tuần integration 18/5-24/5
...
Danh sách kiểm tra này dùng để Team 1 nối frontend với backend mà không đoán schema và không bỏ sót edge cases. Branch hiện đã rebase trên `origin/main` sau PR #9, nên checklist dưới đây bám theo schema real-data hiện tại và còn cần smoke test trước khi Team 1 nối UI.
...
| API-15 | Bias warning                 | Request vùng yếu độ phủ                                              | UI/API hiển thị limitation                                               | Phúc/Thịnh/Sơn | Important |
...
| UI-06 | Cảnh báo độ phủ                   | Cảnh báo khi chọn Dak Nong/Dak R'lap hoặc vùng yếu   | Phúc/Thịnh/Sơn | Important    |
