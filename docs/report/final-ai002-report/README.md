...
| **Chương 3** | Dữ liệu & Thiết kế: Nguồn dữ liệu, Tiền xử lý, Kiến trúc 4 tầng Responsible AI, Explainability Engine | [03-data-and-design.md](03-data-and-design.md) | Thanh / Sơn | Pending |
| **Chương 4** | Hiện thực hóa: Feature engineering, Code sanitize_inputs (Robustness), Config safety prompt (Reliability) | [04-implementation.md](04-implementation.md) | Thanh / Phúc | Pending |
| **Chương 5** | Thực nghiệm & Đánh giá: Thiết lập split temporal, kết quả metrics thật trên tập Test 2025, Kịch bản test 5 trục | [05-experiments-and-evaluation.md](05-experiments-and-evaluation.md) | Sơn / Thanh | Pending |
| **Chương 6** | Kết luận đạt được, hạn chế mô hình và định hướng phát triển tương lai | [06-conclusion-and-future-work.md](06-conclusion-and-future-work.md) | Sơn / Phúc | Pending |
| **Phụ lục** | Tài liệu tham khảo, API Request/Response mẫu, Link Github, Screenshots demo | [appendices.md](appendices.md) | Cả nhóm | Pending |
