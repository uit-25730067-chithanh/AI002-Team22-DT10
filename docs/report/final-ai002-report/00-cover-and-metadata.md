...
| 2   | 25730063     | Đặng Chí Thanh (Trưởng nhóm) | Kỹ thuật ML (Feature Engineering, Preprocessing, Train RF Baseline), Viết Backend API (FastAPI). Phụ trách trục Reliability và Explainability. | 100%            |
