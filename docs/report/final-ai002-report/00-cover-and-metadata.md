...
Về mặt kỹ thuật, hệ thống sử dụng thuật toán **Random Forest Regressor** để dự báo giá cà phê dựa trên dữ liệu giá lịch sử cùng các đặc trưng khí tượng (nhiệt độ, lượng mưa, độ ẩm). Dữ liệu được tổng hợp theo tháng (monthly) từ năm 2020 đến 2026. Mô hình được huấn luyện trên dữ liệu giai đoạn 2020–2024 và đánh giá chính thức trên dữ liệu năm 2025 (phân chia theo chuỗi thời gian - temporal split). Kết quả thực nghiệm cho thấy mô hình baseline đạt sai số tuyệt đối trung bình (MAE) là **14,474 VND/kg**, sai số bình phương trung bình dạng căn (RMSE) là **17,874 VND/kg**.

Nhằm đảm bảo tính bền vững và thực tế, hệ thống tích hợp lớp validate dữ liệu đầu vào, cảnh báo thiên lệch dữ liệu địa lý giữa các tỉnh (Kon Tum 88.16%, Lâm Đồng 86.84%, Đắk Nông 60.53%), và cung cấp khả năng bóc tách mức độ đóng góp đặc trưng (Feature Importance) giúp người nông dân dễ dàng đối chiếu lý do đưa ra dự báo. Hệ thống backend được xây dựng bằng **FastAPI** và bàn giao thông tin đầu ra chi tiết cho lớp giao diện di động (Mobile-first UI), giúp người dùng cuối tiếp cận dữ liệu một cách trực quan, tối ưu và bình đẳng.
