...
gantt
    ...
    Validate categorical inputs              :done, d2, 2026-05-13, 1d
...
sequenceDiagram
    ...
    UI->>API: POST /predict
    API->>Schema: Validate province, area, weather, soil, price
...
- [x] API validate categorical inputs để tránh one-hot all-zero.
...
flowchart TD
    ...
    A --> D[Frontend gửi category ngoài tập train]
    ...
    D --> D1[API trả 422 thay vì predict OOD]
