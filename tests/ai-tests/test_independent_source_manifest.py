...
def test_manifest_outputs_do_not_point_to_old_data() -> None:
    ...
    assert "independent" in output_values
    assert "coffee_environment_all_areas_monthly_2022_2025.csv" not in output_values
    assert "coffee_environment_all_areas_weekly_2022_2025.csv" not in output_values
